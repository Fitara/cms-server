...
describe("GET /posts", function () {
  ...
  it("should send a response with 200 status code and data type is object", async function () {
    const res = await request(app).get("/pub/posts?filter=1").send({ filter });
  ...
  //   expect(typeof res.body[0].Category.id).toEqual(1);
  });

  // it("should send a response with 200 status code and data type is object", async function () {
  //   const res = await request(app).get("/pub/posts?filter=1").send({ page });

  //   expect(res.status).toEqual(200);
  //   expect(Array.isArray(res.body)).toEqual("array");
  //   expect(typeof res.body[0]).toEqual("object");
  ...
  //   expect(typeof res.body[0].User).toEqual("object");
  //   expect(typeof res.body[0].Category).toEqual("object");
  //   // expect(typeof res.body[0]).toEqual(1);
  // });
